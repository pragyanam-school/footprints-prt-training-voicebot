...
var daily_esm_exports = /* @__PURE__ */ __exportAll({
...
function B(e) {
	return null != e && e.callObjectBundleUrlOverride ? e.callObjectBundleUrlOverride : F("https://c.daily.co/call-machine/versioned/".concat("0.85.0", "/static/call-machine-object-bundle.js"), e);
}
function U(e) {
	try {
		new URL(e);
...
function Ne(e, t) {
	try {
		e.prototype = t.prototype = t.prototype || {}, De(e, "__sentry_original__", t);
	} catch (e) {}
}
function Re(e) {
...
function _t(e) {
	const { traceId: n, spanId: r, parentSpanId: i } = e.getPropagationContext();
	return Ve({
		trace_id: n,
		span_id: r,
		parent_span_id: i
...
function wt(e) {
	...
	if (!t) return;
	const n = {};
	for (const [, [e, r]] of t) (n[e] || (n[e] = [])).push(Ve(r));
	return n;
}
function kt(e) {
	const t = function(e) {
...
function Ut(e, t = 100, n = Infinity) {
	try {
		return Jt("", e, t, n);
	} catch (e) {
...
function Jt(e, t, n = Infinity, r = Infinity, i = function() {
	const e = "function" == typeof WeakSet, t = e ? /* @__PURE__ */ new WeakSet() : [];
	return [function(n) {
...
function Ht(e) {
	...
	function i(e) {
		"string" == typeof r ? r = "string" == typeof e ? r + e : [Wt(r), e] : r.push("string" == typeof e ? Wt(e) : e);
	}
	for (const e of n) {
		const [t, n] = e;
...
function on(e, t) {
	...
	sn(e, "extra", n), sn(e, "tags", r), sn(e, "user", i), sn(e, "contexts", o), e.sdkProcessingMetadata = ot(e.sdkProcessingMetadata, a, 2), s && (e.level = s), h && (e.transactionName = h), f && (e.span = f), c.length && (e.breadcrumbs = [...e.breadcrumbs, ...c]), l.length && (e.fingerprint = [...e.fingerprint, ...l]), u.length && (e.eventProcessors = [...e.eventProcessors, ...u]), d.length && (e.attachments = [...e.attachments, ...d]), e.propagationContext = {
...
function an(e, t, n, r, i, o) {
	...
	if (o) on(p, o.getScopeData());
	if (u) on(p, u.getScopeData());
	const h = [...n.attachments || [], ...p.attachments];
	h.length && (n.attachments = h), rn(c, p);
	return Zt([...d, ...p.eventProcessors], c, n).then(((e) => (e && function(e) {
		const t = {};
		try {
			e.exception.values.forEach(((e) => {
				e.stacktrace.frames.forEach(((e) => {
		...
		const r = {
			...
			...e.breadcrumbs && { breadcrumbs: e.breadcrumbs.map(((e) => ({
				...e,
				...e.data && { data: Ut(e.data, t, n) }
			}))) },
			...e.user && { user: Ut(e.user, t, n) },
			...e.contexts && { contexts: Ut(e.contexts, t, n) },
			...e.extra && { extra: Ut(e.extra, t, n) }
		};
...
function dn(e) {
	...
	return c && "ok" === c.status && nt(c, { status: "exited" }), pn(), n.setSession(a), r.setSession(a), a;
}
function pn() {
	const e = yt(), t = mt(), n = t.getSession() || e.getSession();
	n && function(e, t) {
		let n = {};
		t ? n = { status: t } : "ok" === e.status && (n = { status: "exited" }), nt(e, n);
...
function Cn(e, { statusCode: t, headers: n }, r = Date.now()) {
	const i = { ...e }, o = n && n["x-sentry-rate-limits"], s = n && n["retry-after"];
...
function En(e, t, n = Mn(e.bufferSize || 64)) {
	...
	return {
		send: function(i) {
			...
			return n.add((() => t({ body: Ht(s) }).then(((e) => (void 0 !== e.statusCode && (e.statusCode < 200 || e.statusCode >= 300) && V && Q.warn(`Sentry responded with status code ${e.statusCode} to sent event.`), r = Cn(r, e), e)), ((e) => {
...
function Rn(e, t, n, r, i, o, s, a) {
	...
	if (Ce(r[i], Error)) {
		...
		Bn(o, i, l, a), c = Rn(e, t, n, r[i], i, [o, ...c], o, l);
	}
	return Array.isArray(r.errors) && r.errors.forEach(((r, o) => {
		if (Ce(r, Error)) {
			Fn(s, a);
			const l = e(t, r), u = c.length;
			Bn(l, `errors[${o}]`, u, a), c = Rn(e, t, n, r, i, [l, ...c], l, u);
		}
	})), c;
}
function Fn(e, t) {
...
function Yn(e, t) {
	...
	oe(n, e), se(n, (() => function(e, t = !1) {
		...
		Le($, "fetch", (function(t) {
			return function(...n) {
				const r = /* @__PURE__ */ new Error(), { method: i, url: o } = function(e) {
				...
				return e || ae("fetch", { ...s }), t.apply($, n).then((async (t) => (e ? e(t) : ae("fetch", {
					...s,
					endTimestamp: 1e3 * qe(),
					response: t
				}), t)), ((e) => {
...
function ar(e, t, n, r) {
	...
	}(t), a = { __serialized__: Vt(t, o) };
	if (s) return {
		exception: { values: [sr(e, s)] },
		extra: a
	};
	const c = {
		exception: { values: [{
			type: ke(t) ? t.constructor.name : r ? "UnhandledRejection" : "Error",
			value: gr(t, { isUnhandledRejection: r })
		}] },
		extra: a
	};
	if (n) {
...
function cr(e, t) {
	return { exception: { values: [sr(e, t)] } };
}
function lr(e, t) {
...
function pr(e) {
	const t = e && e.name;
	if (!t && dr(e)) return e.message && Array.isArray(e.message) && 2 == e.message.length ? e.message[0] : "WebAssembly.Exception";
	return t;
}
function hr(e) {
	const t = e && e.message;
...
function fr(e, t, n, r, i) {
	let o;
	if (me(t) && t.error) return cr(e, t.error);
	...
	if (Se(t) || ke(t)) return o = ar(e, t, n, i), Qe(o, { synthetic: !0 }), o;
	return o = vr(e, t, n, r), Ge(o, `${t}`, void 0), Qe(o, { synthetic: !0 }), o;
}
function vr(e, t, n, r) {
	const i = {};
	if (r && n) {
...
function gr(e, { isUnhandledRejection: t }) {
	...
	if (ke(e)) return `Event \`${function(e) {
		try {
			const t = Object.getPrototypeOf(e);
...
function Mr() {
	...
	br.document.addEventListener("click", t, !1), br.document.addEventListener("keypress", t, !1), ["EventTarget", "Node"].forEach(((t) => {
		...
		r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (Le(r, "addEventListener", (function(t) {
			return function(n, r, i) {
				if ("click" === n || "keypress" == n) try {
					const r = this.__sentry_instrumentation_handlers__ = this.__sentry_instrumentation_handlers__ || {}, o = r[n] = r[n] || { refCount: 0 };
					if (!o.handler) {
						const r = Cr(e);
...
function jr() {
	...
	e.open = new Proxy(e.open, { apply(e, t, n) {
		const r = /* @__PURE__ */ new Error(), i = 1e3 * qe(), o = be(n[0]) ? n[0].toUpperCase() : void 0, s = function(e) {
			if (be(e)) return e;
			try {
				return e.toString();
			} catch (e) {}
		...
		return "onreadystatechange" in t && "function" == typeof t.onreadystatechange ? t.onreadystatechange = new Proxy(t.onreadystatechange, { apply: (e, t, n) => (a(), e.apply(t, n)) }) : t.addEventListener("readystatechange", a), t.setRequestHeader = new Proxy(t.setRequestHeader, { apply(e, t, n) {
			const [r, i] = n, o = t[Ar];
...
function Wr(e) {
	return function(t) {
		return e.apply(this, [ir(t, { mechanism: {
			data: {
...
function Gr(e) {
	...
	n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (Le(n, "addEventListener", (function(t) {
		return function(n, r, i) {
			try {
				"function" == typeof r.handleEvent && (r.handleEvent = ir(r.handleEvent, { mechanism: {
					data: {
...
function ss() {
	return !!(navigator && navigator.mediaDevices && navigator.mediaDevices.getDisplayMedia) && (function(e, t) {
		...
		switch (e) {
			...
			case "Safari": return RTCRtpTransceiver.prototype.hasOwnProperty("currentDirection") && !(13 === t.major && 0 === t.minor && 0 === t.point);
...
function ps() {
	...
	return !is() && ds !== cs && (e ? function() {
		...
		if ("Chrome" === e) return bs().major >= 77;
		if ("Firefox" === e) return ks().major >= 97;
		return [
			"Chrome",
			"Firefox",
			"Safari"
...
function fs() {
	return os() && "undefined" != typeof MediaStreamTrack && !function() {
		...
		if (!rs()) return !0;
		switch (t) {
			case "Chrome": return (e = bs()).major && e.major > 0 && e.major < 75;
			case "Firefox": return (e = ks()).major < 91;
			case "Safari": return (e = Ss()).major < 13 || 13 === e.major && e.minor < 1;
			default: return !0;
		}
	}();
}
...
function ys() {
	switch (ms()) {
		case "Chrome": return bs();
		case "Safari": return Ss();
		case "Firefox": return ks();
...
function Zs(e, t) {
	for (var n = t.getState(), r = 0, i = ["cam", "screen"]; r < i.length; r++) for (var o = i[r], s = 0, a = ["video", "audio"]; s < a.length; s++) {
...
function cc(e, t, n) {
	...
	e.audio && e.audio.processor && (hs() || (e.audio.settings ? delete e.audio.processor : delete e.audio, i.push("audio"))), i.length > 0 && console.error("Ignoring settings for browser- or platform-unsupported input processor(s): ".concat(i.join(", "))), e.audio && e.audio.settings && (e.audio.settings.customTrack ? (n.audioTrack = e.audio.settings.customTrack, e.audio.settings = { customTrack: Qo }) : delete n.audioTrack), e.video && e.video.settings && (e.video.settings.customTrack ? (n.videoTrack = e.video.settings.customTrack, e.video.settings = { customTrack: Qo }) : delete n.videoTrack);
}
function lc(e) {
...
function uc(e) {
	...
	if (e.config) {
		...
		if (!function(e, t) {
			...
			switch (e) {
				case Ko.BGBLUR: return n.length > 1 || "strength" !== n[0] ? (console.error(r), !1) : !("number" != typeof t.strength || t.strength <= 0 || t.strength > 1 || isNaN(t.strength)) || (console.error("".concat(r, "; expected: {0 < strength <= 1}, got: ").concat(t.strength)), !1);
				case Ko.BGIMAGE: return !(void 0 !== t.source && !function(e) {
	...
	if (e) for (var t = 0, r = Object.entries(e); t < r.length; t++) for (var i = f(r[t], 1)[0], o = 0, s = Object.entries(e[i]); o < s.length; o++) {
		...
		switch (c) {
			...
			case "visualState":
				...
				break;
			default: if (n(l) !== u) return console.error("customTrayButton ".concat(c, " should be a ").concat(u, ".")), !1;
		}
	}
	return !0;
}
		...
		for (var a = 0, c = Object.entries(e[s]); a < c.length; a++) {
			...
			switch (u) {
				...
				case "srcdoc":
					...
					break;
				case "location":
					if (!["main", "sidebar"].includes(d)) return r(s, t(u)), !1;
					break;
				case "controlledBy":
				...
				case "shared":
					...
					break;
				default: if (!qa.id[u]) return console.error("customIntegration does not support key ".concat(u)), !1;
			}
		}
	}
	return !0;
...
var g, m, y, b, _, k, M, C, E, T, O, P, A, j, I, x, L, D, V, J, $, z, W, H, Q, K, Y, X, ee, re, ie, ce, ue, fe, Te, qe, Ye, et, st, lt, ut, dt, St, Ct, xt, Nt, Qt, en, tn, nn, ln, gn, bn, _n, wn, On, An, jn, In, xn, Ln, $n, Gn, er, tr, nr, or, ur, mr, yr, br, _r, wr, Sr, kr, Or, Ar, Lr, Dr, Nr, Rr, Fr, Br, Ur, Vr, Jr, $r, qr, Qr, Kr, Zr, ei, ni, ri, ii, oi, si, ai, ci, ui, di, pi, hi, fi, vi, gi, mi, yi, _i, wi, Si, ki, Mi, Ci, Ei, Ti, Oi, Pi, Ai, ji, Ii, xi, Li, Di, Ni, Ri, Fi, Bi, Ui, Vi, Ji, $i, qi, zi, Wi, Hi, Gi, Qi, Ki, Yi, Xi, Zi, eo, to, no, ro, io, oo, so, ao, co, lo, uo, po, ho, fo, vo, go, mo, yo, bo, _o, wo, So, ko, Mo, Co, Eo, To, Oo, Po, Ao, jo, Io, xo, Lo, Do, No, Ro, Fo, Bo, Uo, Vo, Jo, $o, qo, zo, Wo, Ho, Go, Qo, Ko, Yo, Xo, Zo, es, ts, ns, cs, ls, us, ds, Ms, Os, js, Is, xs, Ls, Ds, Us, Vs, Js, $s, qs, zs, Ws, Hs, Gs, Qs, Ks, Ys, Xs, oa, sa, la, ua, fa, ya, ba, _a, wa, Sa, ka, Ma, Ca, Ea, Ta, Oa, La, Da, Na, Ra, Fa, Ba, Ua, Va, Ja, $a, qa, za, Wa, Ha;
var init_daily_esm = __esmMin((() => {
	m = { exports: {} };
	y = function() {
		...
		m.exports = i, m.exports.once = function(e, t) {
			return new Promise((function(n, r) {
				...
				f(e, t, o, { once: !0 }), "error" !== t && function(e, t, n) {
		...
		function c(e, t, n, r) {
			...
			else if ("function" == typeof c ? c = o[t] = r ? [n, c] : [c, n] : r ? c.unshift(n) : c.push(n), (i = a(e)) > 0 && c.length > i && !c.warned) {
				c.warned = !0;
				var u = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + c.length + " " + String(t) + " listeners added. Use emitter.setMaxListeners() to increase limit");
	...
	O = class O {
		...
		static assign(e, ...t) {
			...
			for (r = 0, i = t.length; r < i; r += 1) {
				const e = t[r];
				if ("object" == typeof e && null !== e) Object.keys(e).forEach(((t) => {
					n[t] = e[t];
				}));
			}
			return e;
	...
	P = /version\/(\d+(\.?_?\d+)+)/i, A = [
		{
			test: [/googlebot/i],
			describe(e) {
				const t = { name: "Googlebot" }, n = O.getFirstMatch(/googlebot\/(\d+(\.\d+))/i, e) || O.getFirstMatch(P, e);
		...
		},
		{
			test: [/opera/i],
			describe(e) {
				const t = { name: "Opera" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:opera)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/opr\/|opios/i],
			describe(e) {
				const t = { name: "Opera" }, n = O.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Samsung Internet for Android" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/Whale/i],
			describe(e) {
				const t = { name: "NAVER Whale Browser" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:whale)[\s/](\d+(?:\.\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/MZBrowser/i],
			describe(e) {
				const t = { name: "MZ Browser" }, n = O.getFirstMatch(/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/focus/i],
			describe(e) {
				const t = { name: "Focus" }, n = O.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/swing/i],
			describe(e) {
				const t = { name: "Swing" }, n = O.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/coast/i],
			describe(e) {
				const t = { name: "Opera Coast" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:coast)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/opt\/\d+(?:.?_?\d+)+/i],
			describe(e) {
				const t = { name: "Opera Touch" }, n = O.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/yabrowser/i],
			describe(e) {
				const t = { name: "Yandex Browser" }, n = O.getFirstMatch(/(?:yabrowser)[\s/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/ucbrowser/i],
			describe(e) {
				const t = { name: "UC Browser" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Maxthon" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/epiphany/i],
			describe(e) {
				const t = { name: "Epiphany" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/puffin/i],
			describe(e) {
				const t = { name: "Puffin" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/sleipnir/i],
			describe(e) {
				const t = { name: "Sleipnir" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/k-meleon/i],
			describe(e) {
				const t = { name: "K-Meleon" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "WeChat" }, n = O.getFirstMatch(/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/qqbrowser/i],
			describe(e) {
				const t = { name: /qqbrowserlite/i.test(e) ? "QQ Browser Lite" : "QQ Browser" }, n = O.getFirstMatch(/(?:qqbrowserlite|qqbrowser)[/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/msie|trident/i],
			describe(e) {
				const t = { name: "Internet Explorer" }, n = O.getFirstMatch(/(?:msie |rv:)(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/\sedg\//i],
			describe(e) {
				const t = { name: "Microsoft Edge" }, n = O.getFirstMatch(/\sedg\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/edg([ea]|ios)/i],
			describe(e) {
				const t = { name: "Microsoft Edge" }, n = O.getSecondMatch(/edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/vivaldi/i],
			describe(e) {
				const t = { name: "Vivaldi" }, n = O.getFirstMatch(/vivaldi\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/seamonkey/i],
			describe(e) {
				const t = { name: "SeaMonkey" }, n = O.getFirstMatch(/seamonkey\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/sailfish/i],
			describe(e) {
				const t = { name: "Sailfish" }, n = O.getFirstMatch(/sailfish\s?browser\/(\d+(\.\d+)?)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/silk/i],
			describe(e) {
				const t = { name: "Amazon Silk" }, n = O.getFirstMatch(/silk\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/phantom/i],
			describe(e) {
				const t = { name: "PhantomJS" }, n = O.getFirstMatch(/phantomjs\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/slimerjs/i],
			describe(e) {
				const t = { name: "SlimerJS" }, n = O.getFirstMatch(/slimerjs\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "BlackBerry" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/(web|hpw)[o0]s/i],
			describe(e) {
				const t = { name: "WebOS Browser" }, n = O.getFirstMatch(P, e) || O.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/bada/i],
			describe(e) {
				const t = { name: "Bada" }, n = O.getFirstMatch(/dolfin\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/tizen/i],
			describe(e) {
				const t = { name: "Tizen" }, n = O.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/qupzilla/i],
			describe(e) {
				const t = { name: "QupZilla" }, n = O.getFirstMatch(/(?:qupzilla)[\s/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Firefox" }, n = O.getFirstMatch(/(?:firefox|iceweasel|fxios)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/electron/i],
			describe(e) {
				const t = { name: "Electron" }, n = O.getFirstMatch(/(?:electron)\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/MiuiBrowser/i],
			describe(e) {
				const t = { name: "Miui" }, n = O.getFirstMatch(/(?:MiuiBrowser)[\s/](\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/chromium/i],
			describe(e) {
				const t = { name: "Chromium" }, n = O.getFirstMatch(/(?:chromium)[\s/](\d+(\.?_?\d+)+)/i, e) || O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Chrome" }, n = O.getFirstMatch(/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/GSA/i],
			describe(e) {
				const t = { name: "Google Search" }, n = O.getFirstMatch(/(?:GSA)\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Android Browser" }, n = O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "PlayStation 4" }, n = O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: "Safari" }, n = O.getFirstMatch(P, e);
				return n && (t.version = n), t;
			}
		},
		{
	...
	j = [
		...
		},
		{
			...
			describe(e) {
				const t = { name: E.iOS }, n = O.getSecondMatch(/(Version\/)(\d[\d.]+)/, e);
				return n && (t.version = n), t;
			}
		},
		{
		...
		},
		{
			test: [/(web|hpw)[o0]s/i],
			describe(e) {
				const t = O.getFirstMatch(/(?:web|hpw)[o0]s\/(\d+(\.\d+)*)/i, e), n = { name: E.WebOS };
		...
		{
			test: [/linux/i],
			describe: () => ({ name: E.Linux })
		},
		{
			test: [/CrOS/],
			describe: () => ({ name: E.ChromeOS })
		},
		{
			test: [/PlayStation 4/],
			describe(e) {
	...
	], x = [
		{
			...
			describe(e) {
				if (/\sedg\//i.test(e)) return { name: T.Blink };
		...
		},
		{
			test: [/trident/i],
			describe(e) {
				const t = { name: T.Trident }, n = O.getFirstMatch(/trident\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: T.Presto }, n = O.getFirstMatch(/presto\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			...
			describe(e) {
				const t = { name: T.Gecko }, n = O.getFirstMatch(/gecko\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		},
		{
			test: [/(apple)?webkit\/537\.36/i],
			describe: () => ({ name: T.Blink })
		},
		{
			test: [/(apple)?webkit/i],
			describe(e) {
				const t = { name: T.WebKit }, n = O.getFirstMatch(/webkit\/(\d+(\.?_?\d+)+)/i, e);
				return n && (t.version = n), t;
			}
		}
	];
	...
	V = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, J = "8.55.0", $ = globalThis;
	z = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, W = [
		"debug",
		"info",
		"warn",
		"error",
	...
	lt = class lt {
		...
		clone() {
			const e = new lt();
			return e._breadcrumbs = [...this._breadcrumbs], e._tags = { ...this._tags }, e._extra = { ...this._extra }, e._contexts = { ...this._contexts }, this._contexts.flags && (e._contexts.flags = { values: [...this._contexts.flags.values] }), e._user = this._user, e._level = this._level, e._session = this._session, e._transactionName = this._transactionName, e._fingerprint = this._fingerprint, e._eventProcessors = [...this._eventProcessors], e._requestSession = this._requestSession, e._attachments = [...this._attachments], e._sdkProcessingMetadata = { ...this._sdkProcessingMetadata }, e._propagationContext = { ...this._propagationContext }, e._client = this._client, e._lastEventId = this._lastEventId, at(e, ct(this)), e;
		}
		setClient(e) {
			this._client = e;
		}
		...
		setUser(e) {
			return this._user = e || {
				...
				ip_address: void 0,
				username: void 0
			}, this._session && nt(this._session, { user: e }), this._notifyScopeListeners(), this;
		}
		getUser() {
			return this._user;
		}
		...
		update(e) {
			if (!e) return this;
			const t = "function" == typeof e ? e(this) : e, [n, r] = t instanceof ut ? [t.getScopeData(), t.getRequestSession()] : Se(t) ? [e, e.requestSession] : [], { tags: i, extra: o, user: s, contexts: a, level: c, fingerprint: l = [], propagationContext: u } = n || {};
			return this._tags = {
				...this._tags,
				...i
			}, this._extra = {
		...
		captureException(e, t) {
			...
			const r = /* @__PURE__ */ new Error("Sentry syntheticException");
	...
	dt = class {
		constructor(e, t) {
			let n, r;
			n = e || new ut(), r = t || new ut(), this._stack = [{ scope: n }], this._isolationScope = r;
		}
		withScope(e) {
	...
	wn = class {
		...
		captureSession(e) {
			"string" != typeof e.release ? V && Q.warn("Discarded session because of missing or non-string release") : (this.sendSession(e), nt(e, { init: !1 }));
		}
		getDsn() {
			return this._dsn;
		}
		...
		addIntegration(e) {
			...
			yn(this, e, this._integrations), t || mn(this, [e]);
		}
		sendEvent(e, t = {}) {
		...
		_flushOutcomes() {
			...
			const t = (n = e, $t((r = this._options.tunnel && Rt(this._dsn)) ? { dsn: r } : {}, [[{ type: "client_report" }, {
				timestamp: i || $e(),
				discarded_events: n
			}]]));
			var n, r, i;
	...
	mr = class extends wn {
		constructor(e) {
			...
			})(t, "browser", ["browser"], tr.SENTRY_SDK_SOURCE || "npm"), super(t), t.sendClientReports && tr.document && tr.document.addEventListener("visibilitychange", (() => {
	...
	yr = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, br = $;
	Or = {};
	Ar = "__sentry_xhr_v3__";
	Lr = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i, Dr = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, Nr = /\((\S*)(?::(\d+))(?::(\d+))\)/, Rr = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i, Fr = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, Br = function(...e) {
		...
		return n || r ? [-1 !== e.indexOf("@") ? e.split("@")[0] : K, n ? `safari-extension:${t}` : `safari-web-extension:${t}`] : [e, t];
	}, Vr = 1024, Jr = (e = {}) => {
		const t = {
			console: !0,
			dom: !0,
			...
			setup(e) {
				...
				t.console && function(e) {
					...
					return function(n) {
						...
						s && s > Vr && (or && Q.warn(`\`dom.maxStringLength\` cannot exceed 1024, but a value of ${s} was configured. Sentry will use 1024 instead.`), s = Vr), "string" == typeof o && (o = [o]);
						try {
						...
						i && (a.data = { "ui.component_name": i }), Pn(a, {
							event: n.event,
							name: n.name,
							global: n.global
						});
					...
					return function(t) {
						...
						if (r && (!t.fetchData.url.match(/sentry_key/) || "POST" !== t.fetchData.method)) if (t.error) Pn({
							category: "fetch",
							data: t.fetchData,
							level: "error",
							type: "http"
	...
	$r = [
		...
		return {
			...
			setupOnce() {
				...
				if (e) (Array.isArray(e) ? e : $r).forEach(Gr);
			}
		};
	};
	Qr = () => ({
		name: "BrowserSession",
		setupOnce() {
			void 0 !== tr.document ? (dn({ ignoreDuration: !0 }), fn(), Er((({ from: e, to: t }) => {
				void 0 !== e && e !== t && (dn({ ignoreDuration: !0 }), fn());
	...
	cs = "none", ls = "software", us = "hardware";
	ds = function() {
		try {
	...
	}(), Is = "replace", xs = "shallow-merge", Ls = [Is, xs];
	Ds = function() {
		function e() {
	...
	Us = function() {
		...
		return i && i[t] ? -1 === [
			...
			"rmpAudio",
			"rmpVideo"
		].indexOf(n) && i[t].custom ? [!0, "staged"].includes(i[t].custom) ? r(i[t].custom) : r(i[t].custom[n]) : r(i[t][n]) : !i || r(i.ALL);
	}, Ys = function(e, t, n, r) {
	...
	oa = /* @__PURE__ */ new Map(), sa = null;
	la = /* @__PURE__ */ new Map(), ua = null;
	fa = /* @__PURE__ */ new Set();
	ya = Object.freeze({
		VIDEO: "video",
		AUDIO: "audio",
	...
	Ca = function() {
		...
		return o(e, [
			...
			},
			{
				...
				value: function() {
					return this.base instanceof Ea && (this.base = this.base.normalize()), this.byUserId && (this.byUserId = Object.fromEntries(Object.entries(this.byUserId).map((function(e) {
						...
						return [n, r instanceof Ea ? r.normalize() : r];
			...
			},
			{
				...
				value: function(e) {
					if ("object" !== n(e)) return [!1, "canReceive must be an object"];
					for (var t = [
						"base",
						"byUserId",
						"byParticipantId"
						...
						if ("base" === o) {
							...
							if ("object" !== n(e[o])) return [!1, "invalid (non-object) value for field '".concat(o, "' in canReceive")];
		...
		return o(e, [
			...
			},
			{
				...
				value: function(e, t) {
					...
					if ("object" !== n(e)) return [!1, "invalid (non-object, non-boolean) value in canReceive"];
					for (var r = Object.keys(e), i = 0, o = r; i < o.length; i++) {
						var s = o[i];
						if (!_a.includes(s)) return [!1, "invalid media type '".concat(s, "' in canReceive")];
						if (Sa.includes(s)) {
							if ("boolean" != typeof e[s]) return [!1, "invalid (non-boolean) value for media type '".concat(s, "' in canReceive")];
						} else {
							if ("object" !== n(e[s])) return [!1, "invalid (non-object) value for media type '".concat(s, "' in canReceive")];
							for (var a = 0, c = Object.values(e[s]); a < c.length; a++) if ("boolean" != typeof c[a]) return [!1, "invalid (non-boolean) value for entry within '".concat(s, "' in canReceive")];
							if (t && void 0 === e[s]["*"]) return [!1, "canReceive \"base\" permission must specify \"*\" as an entry within '".concat(s, "'")];
						}
					}
					return t && r.length !== _a.length ? [!1, "canReceive \"base\" permission must specify all media types: ".concat(_a.join(", "), " (or be set to a boolean shorthand)")] : [!0];
				}
			}
		]);
	}(), Ta = ["result"], Oa = ["preserveIframe"];
	La = {};
	Da = "video", Na = "voice", Ra = is() ? { data: {} } : {
		data: {},
		topology: "none"
	}, Fa = {
		present: 0,
		...
		videoSource: { validate: function(e, t) {
			...
			var n;
			if (e instanceof MediaStreamTrack) t._sharedTracks.videoTrack = e, n = { customTrack: Qo };
			else {
		...
		audioSource: { validate: function(e, t) {
			...
			var n;
			if (e instanceof MediaStreamTrack) t._sharedTracks.audioTrack = e, n = { customTrack: Qo };
			else {
		...
		receiveSettings: {
			validate: function(e) {
				return sc(e, { allowAllParticipantsKey: !1 });
			},
			help: hc({ allowAllParticipantsKey: !1 })
		},
		sendSettings: {
			validate: function(e, t) {
				return !!function(e, t) {
	...
	Ha = function() {
		function r(e) {
			...
			if (window._daily || (window._daily = {
				...
				document.fullscreenElement === i._iframe ? (i.emitDailyJSEvent({ action: "fullscreen" }), i.sendMessageToCallMachine({ action: "fullscreen" })) : (i.emitDailyJSEvent({ action: "exited-fullscreen" }), i.sendMessageToCallMachine({ action: "exited-fullscreen" }));
			})) : i._iframe.webkitRequestFullscreen && i._iframe.addEventListener("webkitfullscreenchange", (function() {
				document.webkitFullscreenElement === i._iframe ? (i.emitDailyJSEvent({ action: "fullscreen" }), i.sendMessageToCallMachine({ action: "fullscreen" })) : (i.emitDailyJSEvent({ action: "exited-fullscreen" }), i.sendMessageToCallMachine({ action: "exited-fullscreen" }));
			}))), is()) {
				var f = i.nativeUtils();
		...
		return l(r, b), o(r, [
			{
				...
				value: (ee = p((function* () {
					...
					this._callObjectMode && this.stopListeningForDeviceChanges(), this.resetMeetingDependentVars(), this._destroyed = !0, this.emitDailyJSEvent({ action: "call-instance-destroyed" }), delete La[this.callClientId], !(null === (e = window) || void 0 === e || null === (e = e._daily) || void 0 === e) && e.instances && delete window._daily.instances[this.callClientId], this.strictMode && (this.callClientId = void 0);
				})), function() {
				...
				value: (Z = p((function* () {
					...
					return new Promise((function(n, i) {
						e.sendMessageToCallMachine({
							...
							e.error && i(e.error), e.id || i(/* @__PURE__ */ new Error("unknown error in updateWaitingParticipant()")), n({ id: e.id });
						}));
					}));
				})), function() {
				...
				value: (X = p((function* () {
					...
					return new Promise((function(n, r) {
						e.sendMessageToCallMachine({
							...
							e.error && r(e.error), e.ids || r(/* @__PURE__ */ new Error("unknown error in updateWaitingParticipants()")), n({ ids: e.ids });
						}));
					}));
				})), function() {
			...
			},
			{
				key: "requestAccess",
				value: (Y = p((function* () {
					var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.access, r = void 0 === n ? { level: vi } : n, i = t.name, o = void 0 === i ? "" : i;
					return tc(this._callObjectMode, "requestAccess()"), Ka(this._callState, "requestAccess()"), new Promise((function(t, n) {
						e.sendMessageToCallMachine({
							...
							e.error && n(e.error), e.access || n(/* @__PURE__ */ new Error("unknown error in requestAccess()")), t({
								access: e.access,
								granted: e.granted
							});
						}));
			...
			},
			{
				...
				value: (K = p((function* (e) {
					...
					switch (n(e)) {
						...
						default: throw new Error("first argument to getReceiveSettings() must be a participant id (or \"base\"), or there should be no arguments");
					}
				})), function(e) {
			...
			},
			{
				...
				value: (Q = p((function* (e) {
					var t = this;
					if (tc(this._callObjectMode, "updateReceiveSettings()"), !sc(e, { allowAllParticipantsKey: !0 })) throw new Error(hc({ allowAllParticipantsKey: !0 }));
			...
			},
			{
				...
				value: function(e, t) {
					if (e) {
						...
						if (e.audio) {
							var r, i, o;
							e.audio.settings && (!Object.keys(e.audio.settings).length && t || (n.audio = { settings: Aa({}, e.audio.settings) })), t && null !== (r = n.audio) && void 0 !== r && null !== (r = r.settings) && void 0 !== r && r.customTrack && (n.audio.settings = { customTrack: this._sharedTracks.audioTrack });
							...
							if (e.audio.processor && !s) {
								...
								delete a._isDefaultWhenNone, n.audio = Aa(Aa({}, n.audio), {}, { processor: a });
							}
						}
						if (e.video) {
							var c, l, u;
							e.video.settings && (!Object.keys(e.video.settings).length && t || (n.video = { settings: Aa({}, e.video.settings) })), t && null !== (c = n.video) && void 0 !== c && null !== (c = c.settings) && void 0 !== c && c.customTrack && (n.video.settings = { customTrack: this._sharedTracks.videoTrack });
							...
							if (e.video.processor && !d) {
								...
								delete p._isDefaultWhenNone, n.video = Aa(Aa({}, n.video), {}, { processor: p });
							}
						}
						return n;
					}
			...
			},
			{
				key: "setAudioDevice",
				value: (q = p((function* (e) {
					return ic(), this.nativeUtils().setAudioDevice(e), { deviceId: yield this.nativeUtils().getAudioDevice() };
				})), function(e) {
					return q.apply(this, arguments);
				})
			},
				...
				value: (U = p((function* () {
					...
					return this.validateProperties(t), this.properties = Aa(Aa({}, this.properties), t), new Promise((function(t, n) {
						e._preloadCache.inputSettings = e._prepInputSettingsForSharing(e._inputSettings, !1), e.sendMessageToCallMachine({
							...
							return r.error ? n(r.error) : r.access ? (e._didPreAuth = !0, void t({ access: r.access })) : n(/* @__PURE__ */ new Error("unknown error in preAuth()"));
						}));
					}));
				})), function() {
			...
			},
			{
				...
				value: (R = p((function* (e) {
					...
					if (this.needsLoad()) {
						...
						return this._updateCallState(ni), this.emitDailyJSEvent({ action: Vi }), this._callObjectMode ? new Promise((function(e, n) {
							t._callObjectLoader.cancel();
							var r = Date.now();
							t._callObjectLoader.load(t.properties.dailyConfig, (function(n) {
								t._bundleLoadTime = n ? "no-op" : Date.now() - r, t._updateCallState(ri), n && t.emitDailyJSEvent({ action: "loaded" }), e();
							}), (function(e, r) {
							...
							t._loadedCallback = function(r) {
								t._callState !== "error" ? (t._updateCallState(ri), (t.properties.cssFile || t.properties.cssText) && t.loadCss(t.properties), e()) : n(r);
							};
						})));
					}
				})), function(e) {
			...
			},
			{
				...
				value: (L = p((function* () {
					...
					return void 0 !== t.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t.showLocalVideo), void 0 !== t.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t.showParticipantsBar), this._callState === "joined-meeting" || this._callState === "joining-meeting" ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(!1)) : (this._updateCallState(ii, !1), this.emitDailyJSEvent({ action: Wi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, !1), this.sendMessageToCallMachine({
						action: "join-meeting",
						...
						e._joinedCallback = function(i, o) {
							if (e._callState !== "error") {
								if (e._updateCallState("joined-meeting"), i) for (var s in i) {
			...
			},
			{
				...
				value: (x = p((function* () {
					...
					return this._testCallInProgress && this.stopTestCallQuality(), new Promise((function(t) {
						e._callState === "left-meeting" || e._callState === "error" ? t() : e._callObjectLoader && !e._callObjectLoader.loaded ? (e._callObjectLoader.cancel(), e._updateCallState(si), e.resetMeetingDependentVars(), e.emitDailyJSEvent({ action: si }), t()) : (e._resolveLeave = t, e.sendMessageToCallMachine({ action: "leave-meeting" }));
					}));
				})), function() {
					return x.apply(this, arguments);
				})
			...
			},
			{
				...
				value: function() {
					...
					this.sendMessageToCallMachine(Aa({ action: "local-recording-start" }, e));
				}
			},
			{
				key: "updateRecording",
				value: function(e) {
					var t = e.layout, n = void 0 === t ? { preset: "default" } : t, r = e.instanceId;
					this.sendMessageToCallMachine({
			...
			},
			{
				...
				value: function() {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
					this.sendMessageToCallMachine(Aa({ action: "local-recording-stop" }, e));
				}
			},
			{
				...
				value: function() {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
					this.sendMessageToCallMachine(Aa({ action: "daily-method-start-live-streaming" }, e));
				}
			},
			{
			...
			},
			{
				...
				value: function() {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
					this.sendMessageToCallMachine(Aa({ action: "daily-method-stop-live-streaming" }, e));
				}
			},
			{
				...
				value: function(e) {
					...
					if (e) {
						...
						for (var r = 0; r < e.length; r++) {
							...
							} else if (!["active", "scalabilityMode"].includes(o)) throw new Error("Invalid key ".concat(o, ", valid keys are:") + Object.values(Ua));
			...
			},
			{
				...
				value: (j = p((function* (e) {
					var t = this, n = e.url, r = e.settings, i = void 0 === r ? { state: Xo.PLAY } : r;
					try {
						(function(e) {
			...
			},
			{
				...
				value: function(e) {
					Ka(this._callState, "startTranscription()"), this.sendMessageToCallMachine(Aa({ action: "daily-method-start-transcription" }, e));
				}
			},
			{
				...
				value: function(e) {
					...
					this.sendMessageToCallMachine(Aa({ action: "daily-method-update-transcription" }, e));
				}
			},
			{
				...
				value: function(e) {
					...
					this.sendMessageToCallMachine(Aa({ action: "daily-method-stop-transcription" }, e));
				}
			},
			{
				key: "startDialOut",
				value: (O = p((function* (e) {
					...
					return new Promise((function(n, r) {
						t.sendMessageToCallMachine(Aa({ action: "dialout-start" }, e), (function(e) {
			...
			},
			{
				...
				value: function(e) {
					...
					return Ka(this._callState, "stopDialOut()"), new Promise((function(n, r) {
						t.sendMessageToCallMachine(Aa({ action: "dialout-stop" }, e), (function(e) {
							e.error ? r(e.error) : n(e);
						}));
					}));
				}
			},
			{
				...
				value: (T = p((function* (e) {
					...
					return e.useSipRefer = !1, yc(e, "sipCallTransfer"), Ga(e), new Promise((function(n, r) {
						t.sendMessageToCallMachine(Aa({ action: ns }, e), (function(e) {
							e.error ? r(e.error) : n(e);
						}));
					}));
				})), function(e) {
			...
			},
			{
				...
				value: function() {
					var e = this;
					if (this._callState !== "joined-meeting") return Promise.resolve(Aa({ stats: { latest: {} } }, this._network));
					return new Promise((function(t) {
						e.sendMessageToCallMachine({ action: "get-calc-stats" }, (function(n) {
							t(Aa(Aa({}, e._network), {}, { stats: n.stats }));
						}));
					}));
				}
			},
				...
				value: (k = p((function* () {
					...
					return new Promise((function(n) {
						t.sendMessageToCallMachine({
							...
							if ("failed" === s) {
								var c, l = Aa({}, a);
								null !== (c = a.error) && void 0 !== c && c.details ? (a.error.details = JSON.parse(a.error.details), l.error = Aa(Aa({}, l.error), {}, { details: Aa({}, l.error.details) }), l.error.details.duringTest = "testCallQuality") : (l.error = l.error ? Aa({}, l.error) : {}, l.error.details = { duringTest: "testCallQuality" }), t._maybeSendToSentry(l);
							}
							r(!1), n(Aa({ result: s }, a));
						}));
					}));
			...
			},
			{
				...
				value: function() {
					var e = this;
					return new Promise((function(t) {
						if (e._callState === "joined-meeting") e.sendMessageToCallMachine({ action: "get-cpu-load-stats" }, (function(e) {
							t(e.cpuStats);
						}));
						else t({
							cpuLoadState: void 0,
			...
			},
			{
				...
				value: function(e) {
					return rc(), Ka(this._callState, "addFakeParticipant()"), this.sendMessageToCallMachine(Aa({ action: "add-fake-participant" }, e)), this;
				}
			},
			{
			...
			},
			{
				...
				value: function(e) {
					...
					var n = "string" == typeof e ? [e] : e, r = n.filter((function(e) {
			...
			},
			{
				...
				value: function(e) {
					...
					return nc(this._callObjectMode, "setTheme()"), new Promise((function(n, r) {
						try {
							t.validateProperties({ theme: e }), t.properties.theme = Aa({}, e), t.sendMessageToCallMachine({
								action: "set-theme",
					...
					switch (t.action) {
						...
						case eo:
							if (t.meetingSession) {
								...
								var l = Aa(Aa({}, t), {}, { action: "meeting-session-updated" });
						...
						case Jo:
							...
							break;
						case Gi:
							this._callState !== "error" && this._updateCallState("left-meeting"), this.resetMeetingDependentVars(), this._resolveLeave && (this._resolveLeave(), this._resolveLeave = null), this.emitDailyJSEvent(t);
							break;
			...
			},
			{
				...
				value: function() {
					this._participants = {}, this._participantCounts = Fa, this._waitingParticipants = {}, this._activeSpeaker = {}, this._activeSpeakerMode = !1, this._didPreAuth = !1, this._accessState = { access: fi }, this._finalSummaryOfPrevSession = this._meetingSessionSummary, this._meetingSessionSummary = {}, this._meetingSessionState = wc(Ra, this._callObjectMode), this._isScreenSharing = !1, this._receiveSettings = {}, this._inputSettings = void 0, this._sendSettings = {}, this._localAudioLevel = 0, this._isLocalAudioLevelObserverRunning = !1, this._remoteParticipantsAudioLevel = {}, this._isRemoteParticipantsAudioLevelObserverRunning = !1, this._maxAppMessageSize = $o, this._callMachineInitialized = !1, this._bundleLoadTime = void 0, this._preloadCache;
				}
			},
			{
			...
			},
			{
				...
				value: function(e) {
					...
					if (null !== (t = e.error) && void 0 !== t && t.type) {
						...
						if (e.error.type === "no-room" && e.error.msg.includes("deleted")) return;
					}
					...
					e.error && (v.setTag("fatalErrorType", e.error.type), v.setExtra("errorDetails", e.error.details), !(null === (c = e.error.details) || void 0 === c) && c.uri && v.setTag("serverAddress", e.error.details.uri), !(null === (l = e.error.details) || void 0 === l) && l.workerGroup && v.setTag("workerGroup", e.error.details.workerGroup), !(null === (u = e.error.details) || void 0 === u) && u.geoGroup && v.setTag("geoGroup", e.error.details.geoGroup), !(null === (d = e.error.details) || void 0 === d) && d.on && v.setTag("connectionAttempt", e.error.details.on), null !== (p = e.error.details) && void 0 !== p && p.bundleUrl && (v.setTag("bundleUrl", e.error.details.bundleUrl), v.setTag("bundleError", e.error.details.sourceError.type)));
					v.setTags({
...
//#endregion
//#region node_modules/@vapi-ai/web/dist/api.js
...
//#endregion
//#region node_modules/@vapi-ai/web/dist/client.js
var require_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.client = void 0;
	exports.client = new (require_api()).Api({
		baseUrl: "https://api.vapi.ai",
		baseApiParams: { secure: true },
		securityWorker: async (securityData) => {
			if (securityData) return { headers: { Authorization: `Bearer ${securityData}` } };
		}
	});
}));
//#endregion
//#region node_modules/@vapi-ai/web/dist/daily-guards.js
var require_daily_guards = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/@vapi-ai/web/dist/vapi.js
var require_vapi = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function serializeError(error) {
		if (error === null || error === void 0) return { message: "Unknown error (null or undefined)" };
		if (error instanceof Error) {
			...
			if (errorAsAny.code !== void 0) serialized.code = errorAsAny.code;
			if (errorAsAny.cause !== void 0) serialized.cause = String(errorAsAny.cause);
			if (errorAsAny.reason !== void 0) serialized.reason = errorAsAny.reason;
			if (errorAsAny.details !== void 0) serialized.details = errorAsAny.details;
			if (errorAsAny.errorMsg !== void 0) serialized.errorMsg = errorAsAny.errorMsg;
			if (errorAsAny.error !== void 0 && typeof errorAsAny.error === "string") serialized.errorDetail = errorAsAny.error;
			return serialized;
		}
	...
	function destroyAudioPlayer(participantId) {
		document.querySelector(`audio[data-participant-id="${participantId}"]`)?.remove();
	}
	function subscribeToTracks(e, call, isVideoRecordingEnabled, isVideoEnabled) {
		if (e.participant.local) return;
		call.updateParticipant(e.participant.session_id, { setSubscribedTracks: {
			audio: true,
	...
	var Vapi = class extends VapiEventEmitter {
		...
		async start(assistant, assistantOverrides, squad, workflow, workflowOverrides, options) {
			...
			if (!assistant && !squad && !workflow) {
				const error = /* @__PURE__ */ new Error("Assistant or Squad or Workflow must be provided.");
				this.emit("error", {
			...
			try {
				...
				} else this.emit("call-start-progress", {
					stage: "mobile-permissions",
					status: "completed",
					timestamp: (/* @__PURE__ */ new Date()).toISOString(),
				...
				this.call.on("nonfatal-error", (e) => {
					if (e?.type === "audio-processor-error") this.call?.updateInputSettings({ audio: { processor: { type: "none" } } }).then(() => {
		...
		handleRemoteParticipantsAudioLevel(e) {
			...
			this.emit("volume-level", Math.min(1, speechLevel / .15));
			if (!(speechLevel > .01)) return;
		...
		*/
		async reconnect(webCall) {
			const startTime = Date.now();
			if (this.started) throw new Error("Cannot reconnect while a call is already in progress. Call stop() first.");
			if (!webCall.webCallUrl) throw new Error("webCallUrl is required for reconnection.");
			this.emit("call-start-progress", {
		...
		*/
		static async runNetworkTestsStandalone() {
			...
			try {
				...
				let videoTrack = null;
				try {
					videoTrack = (await navigator.mediaDevices.getUserMedia({ video: true })).getVideoTracks()[0];
				...
				try {
					if (typeof tempCall.testCallQuality === "function") try {
						...
						results.callQuality = {
							...
							message: "testCallQuality method not available"
						};
